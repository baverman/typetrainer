...
anti_rsi_keyboard = n130_keyboard.copy()
anti_rsi_keyboard['name'] = 'anti_rsi'
anti_rsi_keyboard['zones'] = [
    ([2, 4, 6, 7, 8, 9, 11, 13],		[1, 2, 3, 4, 5, 1, 2, 3, 0]),
    ([1, 2, 4, 5, 6, 8, 9, 11],		[0, 1, 2, 3, 4, 5, 1, 2, 3]),
    ([1, 2, 3, 4, 6, 8, 9, 10, 12],	[0, 1, 2, 3, 4, 5, 1, 2, 3, 0]),
    ([1, 2, 3, 6, 8, 9, 10, 11],		[0, 2, 3, 4, 5, 1, 2, 3, 0]),
    ([4, 5], [0, 6, 0]),
]
